    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="min-height:468px">
            <div id="page-inner" style="min-height:468px;">
                ...
                <h3>Click the button to get your Nearby Destinations</h3>
				<button onclick="window.location.href='/DB/nearby_results.php'">Click</button>
                
				<?php
				$res = "select 
							td.Country, td.City, td.State, r.Rating
						from
							TouristDestination td
						JOIN
							Review r, `User` u
						where
							td.TouristDestinationId = r.TouristDestinationId
							AND
								r.Rating > '3 stars'
							AND
								td.State = u.State
				...
				{
					echo "<br /><tr><td>".$row['Country']."</td><td>".$row['City']."</td><td>".$row['State']."</td><td>".$row['Rating']."</td></tr>";
				}
				?>
				</table>
