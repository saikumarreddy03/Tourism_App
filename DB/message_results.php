    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="min-height:468px">
            <div id="page-inner" style="min-height:468px;">
				...
				<h3>Click the button to get your Message History</h3>
				<button onclick="window.location.href='/DB/message_results.php'">Click</button>
				<?php
				$res = "select m.Message, m.DateSent
						from
							Message m
						where
							m.SenderUserId = 1";
				...
				{
					echo "<br /><tr><td>".$row['Message']."</td><td>".$row['DateSent']."</td></tr>";
				}
				?>
				</table>
